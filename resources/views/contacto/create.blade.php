            ...
            <form action="{{ route('contactos.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-control w-full col-span-1">
                        ...
                        <input type="text" name="nome" value="{{ old('nome') }}" placeholder="Ex: João Silva" class="input input-bordered input-md w-full focus:input-primary rounded-xl @error('nome') input-error @enderror" required />
                        @error('nome')
                    ...
                    <div class="form-control w-full col-span-1">
                        ...
                        <input type="text" name="alcunha" value="{{ old('alcunha') }}" placeholder="Ex: Silva" class="input input-bordered input-md w-full focus:input-primary rounded-xl @error('alcunha') input-error @enderror" />
                        @error('alcunha')
                            <label class="label py-1"><span class="label-text-alt text-error font-medium">{{ $message }}</span></label>
                        @enderror
                    </div>
                    ...
                    <div class="form-control w-full col-span-1">
                        ...
                        <input type="tel" name="telemovel" value="{{ old('telemovel') }}" placeholder="Ex: 912345678" class="input input-bordered input-md w-full focus:input-primary rounded-xl @error('telemovel') input-error @enderror" required />
                        @error('telemovel')
                            <label class="label py-1"><span class="label-text-alt text-error font-medium">{{ $message }}</span></label>
                        @enderror
                    </div>
                    ...
                    <div class="form-control w-full col-span-1">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="Ex: joaosilva@email.com" class="input input-bordered input-md w-full focus:input-primary rounded-xl @error('email') input-error @enderror" required />
                        @error('email')
                            <label class="label py-1"><span class="label-text-alt text-error font-medium">{{ $message }}</span></label>
                        @enderror
                    </div>
                    ...
                    <div class="form-control w-full col-span-1 md:col-span-2">
                        ...
                        <input type="text" name="localidade" value="{{ old('localidade') }}" placeholder="Ex: Lisboa" class="input input-bordered input-md w-full focus:input-primary rounded-xl @error('localidade') input-error @enderror" required />
                        @error('localidade')
                            <label class="label py-1"><span class="label-text-alt text-error font-medium">{{ $message }}</span></label>
                        @enderror
                    </div>
                    ...
                    <div class="form-control w-full col-span-1 md:col-span-2">
                        ...
                        <textarea name="observacoes" placeholder="Adiciona observações ou notas sobre o contacto..." class="textarea textarea-bordered h-28 w-full focus:textarea-primary rounded-xl @error('observacoes') textarea-error @enderror">{{ old('observacoes') }}</textarea>
                        @error('observacoes')
                            <label class="label py-1"><span class="label-text-alt text-error font-medium">{{ $message }}</span></label>
                        @enderror
                    </div>
