<x-layout title="Detalhes do Contacto - Agenda">
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            <!-- Edit -->
            <a href="{{ route('contactos.edit', $contacto->id) }}" class="btn btn-warning rounded-xl shadow-md gap-1.5 px-5">
        ...
        <div class="card bg-base-100 shadow-xl border border-base-200 rounded-2xl md:col-span-1">
            <div class="card-body items-center text-center p-8">
                ...
                <div class="avatar placeholder mb-4">
                    <div class="{{ $colorClass }} rounded-full w-24 h-24 shadow-lg flex items-center justify-center font-extrabold text-3xl">
                        {{ $firstLetter }}
                    </div>
                </div>
            ...
            <div class="card-body p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="border border-base-200 p-4 rounded-xl flex items-start gap-4">
                        <div class="badge badge-primary p-2 h-10 w-10 shrink-0 rounded-lg flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-primary-content">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-2.824-1.802-5.122-4.1-6.924-6.924l1.293-.97a1.125 1.125 0 0 0 .417-1.173L6.963 3.106a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                            </svg>
                        </div>
                        <div>
                            <div class="text-xs text-base-content/50 font-bold uppercase tracking-wider">Número de Telemóvel</div>
                            <a href="tel:{{ $contacto->telemovel }}" class="text-lg font-black text-base-content link link-hover link-primary mt-0.5 block">
                                {{ $contacto->telemovel }}
                            </a>
                        </div>
                    </div>
                    ...
                    <!-- Email -->
                    <div class="border border-base-200 p-4 rounded-xl flex items-start gap-4">
                        <div class="badge badge-accent p-2 h-10 w-10 shrink-0 rounded-lg flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-accent-content">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                            </svg>
                        </div>
                        <div>
                            <div class="text-xs text-base-content/50 font-bold uppercase tracking-wider">Endereço de Email</div>
                            <a href="mailto:{{ $contacto->email }}" class="text-lg font-black text-base-content link link-hover link-accent mt-0.5 block break-all">
                                {{ $contacto->email }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="border border-base-200 p-4 rounded-xl flex items-start gap-4 sm:col-span-2">
                        <div class="badge badge-info p-2 h-10 w-10 shrink-0 rounded-lg flex items-center justify-center">
                        ...
                        <div>
                            <div class="text-xs text-base-content/50 font-bold uppercase tracking-wider">Localidade / Cidade</div>
                ...
                <div class="border border-base-200 p-5 rounded-xl space-y-3 bg-base-200/25">
                    ...
                    <div class="text-base text-base-content/85 leading-relaxed bg-base-100 p-4 rounded-lg border border-base-200 min-h-24">
                        @if($contacto->observacoes)
                            {!! nl2br(e($contacto->observacoes)) !!}
                        @else
                            <span class="text-base-content/40 italic">Nenhuma observação ou nota registada para este contacto.</span>
                        @endif
                    </div>
                </div>
