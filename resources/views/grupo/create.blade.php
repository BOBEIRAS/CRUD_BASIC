<x-layout title="Adicionar Grupo - Agenda">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold tracking-tight text-base-content">Novo Grupo</h1>
        <p class="text-sm text-base-content/60 mt-1">Regista um novo grupo preenchendo as informações abaixo.</p>
    </div>
            ...
            <form action="{{ route('grupos.store') }}" method="POST" novalidate>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" name="grupo" value="{{ old('grupo') }}" placeholder="Ex: Amigos, Trabalho, Família"
