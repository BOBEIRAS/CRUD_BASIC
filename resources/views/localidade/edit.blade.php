<x-layout title="Editar Localidade - Agenda">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-extrabold tracking-tight text-base-content">Editar Localidade</h1>
        <p class="text-sm text-base-content/60 mt-1">Atualiza os dados de <strong>{{ $localidade->localidade }}</strong> abaixo.
        </p>
    </div>

    <div class="card bg-base-100 shadow-xl border border-base-200 rounded-2xl max-w-xl mx-auto">
        <div class="card-body p-6 md:p-8">
            <form action="{{ route('localidades.update', $localidade->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="text" name="localidade" value="{{ old('localidade', $localidade->localidade) }}" placeholder="Ex: Benavente"
